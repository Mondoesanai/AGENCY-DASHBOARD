...
// Now: ~2 days between shipped changes (the steady drip Google likes and the
// budget needs), but only ~30 minutes between attempts (failures are bounded
// separately: 3 a day, then paused).
const MIN_DISCRETIONARY_GAP_MS = 2 * 24 * 3600000; // between a site's SHIPPED changes
