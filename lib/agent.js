...
${targetItem.detail || ''}
${revisionAttachment ? `\nTEXT OF THE FILE(S) THE CLIENT ATTACHED TO THEIR REQUEST (this is the source of truth for the content to put on the site — use it exactly, do not invent details it does not contain):\n${revisionAttachment}\n` : ''}
