  ...
  for (const t of all) {
    ...
    if (stillOpen) {
      ...
      if (gaveUp) {
        ...
        t.verify = { verified: false, note: 'The agent tried and failed several times in a row and stopped retrying automatically — needs a manual look.', checkedAt: Date.now() };
        changed = true;
      }
      continue;
    }
