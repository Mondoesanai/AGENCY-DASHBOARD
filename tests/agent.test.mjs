...
check('a wrapper that already has an <h1>{{TITLE}}</h1> gets it filled, not shown raw, and only one h1', !/\{\{/.test(livePost) && (livePost.match(/<h1 class="h2">/g) || []).length === 1 && /<h1 class="h2">How Often Should You Detail Your Car\?<\/h1>/.test(livePost));
